...
export const ChatInterface = ({ 
  ...
  return (
    <div className="flex flex-col h-full space-y-4 bg-gradient-to-br from-accent/5 via-background to-primary/5 rounded-xl p-6 shadow-lg border border-accent/20">
